...
export class UserComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private dialogService: NbDialogService, private toastService: NbToastrService, private userService: UserService) { }
  ...
  private setFormInvalid() {
    this.toastService.warning('Existem um ou mais campos obrigatórios que não foram preenchidos.', 'Atenção');
